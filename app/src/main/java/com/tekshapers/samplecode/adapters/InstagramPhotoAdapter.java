package com.tekshapers.samplecode.adapters;
...
import com.tekshapers.samplecode.service.SpiceService;

import java.util.ArrayList;

public class InstagramPhotoAdapter extends ArrayAdapter<Photo> implements
    ...
    private final ImageRequestFactory imageRequestFactory;
    private final SpiceManager spiceManager;

    public InstagramPhotoAdapter(Context context, int layoutRes, int imageRes,
                              ArrayList<Photo> photos, ImageRequestFactory requestFactory) {
    ...
    private void executeImageRequest(int position, ViewMetaData viewMetaData, boolean cacheOnly) {
        Photo photoSource = getItem(position);
